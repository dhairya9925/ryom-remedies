    ...
    <RyomSiteLayout activePath="/careers">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#e88f18] px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#c97912]"
              >
                Contact HR
            ...
            <div className="mt-5 grid gap-3 text-sm font-semibold text-[#3d4947] sm:grid-cols-2 lg:grid-cols-1">
              {[
                ...
                <div key={area} className="flex items-center gap-3 rounded-md bg-white px-4 py-3">
                  <CheckCircle2 className="h-4 w-4 shrink-0 text-[#e88f18]" aria-hidden="true" />
                  {area}
                </div>
              ))}
            </div>
      ...
      <Section tone="light" className="py-16 lg:py-24">
        <div className="mb-10 max-w-3xl">
          <p className="text-sm font-bold uppercase tracking-widest text-[#e88f18]">Why Join Us</p>
      ...
      <Section tone="teal" className="py-16 lg:py-24">
        <div className="mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          ...
          <a
            href="mailto:admin@ryomremedies.com"
            className="inline-flex w-fit items-center justify-center gap-2 rounded-lg bg-[#e88f18] px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#c97912]"
          >
            Share Profile
            <ArrowRight className="h-4 w-4" aria-hidden="true" />
          </a>
        ...
        {openings.length > 0 ? (
          <div className="grid gap-5">
            {openings.map((opening) => (
              ...
              >
                <div className="absolute inset-y-0 left-0 w-1.5 bg-[#e88f18]" aria-hidden="true" />
                <div
                ...
                <div className="relative flex flex-col justify-between gap-5 md:flex-row md:items-start">
                  <div>
                    <span className="inline-flex rounded-full bg-[#fff4e7] px-3 py-1 text-xs font-bold uppercase tracking-widest text-[#c97912]">
                      {opening.department}
                    </span>
                ...
                <ul className="relative mt-6 grid gap-3 rounded-lg border border-[#e1e3e4] bg-white/75 p-4 text-sm leading-6 text-[#3d4947] shadow-inner">
                  {opening.responsibilities.map((item) => (
                    <li key={item} className="flex gap-3">
                      <CheckCircle2
                        className="mt-1 h-4 w-4 shrink-0 text-[#e88f18]"
                        aria-hidden="true"
                      />
                      <span>{item}</span>
                    </li>
          ...
          <div className="rounded-lg border border-dashed border-white/45 bg-white/95 p-8 text-center shadow-sm">
            ...
            <a
              href="mailto:admin@ryomremedies.com"
              className="mt-6 inline-flex items-center justify-center gap-2 rounded-lg bg-[#e88f18] px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#c97912]"
            >
              Send Resume
              <Mail className="h-4 w-4" aria-hidden="true" />
            </a>
